...
set key width -7 right top box opaque spacing 1.2 samplen 1 Left reverse
set key at graph 0.98,0.75 
# unset key
set key maxrow 3
...
file01 u 1:7  w l ls 103 title '\small $\dot{E}_\text{ext}$',\
file01 u 1:8  w l ls 100 lc rgb 'black' title '\small $\dot{E}_\text{all}$',\
