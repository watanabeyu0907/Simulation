...
ifile using (($1+$4*aa)*aj+0.5):(($2+$5*aa)*aj+1):((-cs*$4-sn*$5)*aj*bb):(-(-sn*$4+cs*$5)*aj*bb) ev 8:8:1:1 with vector lw 2 lc rgb 'forest-green' nohead title "",\
'cont.dat' u ($1*aj+0.5):($2*aj+1) w l lw 4 lc rgb '#1a5c8a' t 'Present',\
"case2_TP2D_main.csv" using 1:2 with line lw 4 lc rgb '#ff7f0e' pt 7  title 'TP2D',\
"case2_TP2D_left.csv" using 1:2 with line lw 4 lc rgb '#ff7f0e' pt 7  notitle ,\
"case2_TP2D_right.csv" using 1:2 with line lw 4 lc rgb '#ff7f0e' pt 7  notitle 
