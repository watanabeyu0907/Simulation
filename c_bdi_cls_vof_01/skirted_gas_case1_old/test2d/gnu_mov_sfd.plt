...
set cblabel '{\Large $sft$ [\SI{}]}' offset 0.2,0.0
# set cbrange [-3:3]
# set cbtics 1.0 offset -0.3,0
# set mcbtics 5

set palette defined (0 '#1a1a40', 0.25 '#444466', 0.5 'white', 0.75 '#664444', 1 '#401a1a')
...
aaa = sprintf('{\Large $t = $ %4.2f [\SI{}]}',nn/fps)
...
plot \
ifile u ($1*aj):($2*aj):($20) w image t '',\
