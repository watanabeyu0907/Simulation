...
set terminal epslatex size 2, 2.4 standalone color solid 9
...
set cblabel '{\Large $sfd$ [\SI{}{-}]}' offset 0.2,0.0
# set cbrange [-3:3]
# set cbtics 1.0 offset -0.3,0
set mcbtics 5
...
plot \
ifile u ($1*aj):($2*aj):21 w image t '',\
