...
set format y '$%g$'
set ylabel '{\Large Area, $A\times 10^{3}$ [\SI{}{m^2}]}' offset 0.0,0.0
set yrange [0:0.6]
set ytics 0.2 offset 0,0
set mytics 2


set key width -3 right bottom box opaque spacing 1 samplen 1 Left reverse
...
plot \
file01 u 1:($18*1e3) w l ls 101 title '\small Moving solid',\
file01 u 1:($19*1e3) w l ls 102 title '\small Gas',\
