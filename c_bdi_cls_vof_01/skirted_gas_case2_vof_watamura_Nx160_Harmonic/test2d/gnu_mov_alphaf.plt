...
set terminal epslatex size 2, 2.2 standalone color solid 9
...
ifile using ($1*aj+0.5):($2*aj+1):($4*aa*aj):($5*aa*aj) ev 16:16:1:1 with vector lw 2 lc rgb 'forest-green' nohead title "",\
ifile using (($1+$4*aa)*aj+0.5):(($2+$5*aa)*aj+1):((-cs*$4+sn*$5)*aj*bb):(-( sn*$4+cs*$5)*aj*bb) ev 16:16:1:1 with vector lw 2 lc rgb 'forest-green' nohead title "",\
ifile using (($1+$4*aa)*aj+0.5):(($2+$5*aa)*aj+1):((-cs*$4-sn*$5)*aj*bb):(-(-sn*$4+cs*$5)*aj*bb) ev 16:16:1:1 with vector lw 2 lc rgb 'forest-green' nohead title "",\
'cont.dat' u ($1*aj+0.5):($2*aj+1) w l lw 2 lc rgb 'black' t ''
# "case2_main.csv" using 1:2 with line lw 4 lc rgb 'red' pt 7  notitle ,\
# "case2_left.csv" using 1:2 with line lw 4 lc rgb 'red' pt 7  notitle ,\
# "case2_right.csv" using 1:2 with line lw 4 lc rgb 'red' pt 7  notitle 
