...
set format y '$10^{%L}$'
set ylabel '{\Large $L_2$ \& $L_\infty$ of $\left|\bm{\nabla} \cdot \textit{\textbf{u}} \right|$ [\SI{}{1/s}]}' offset 0.3,0.0
set yrange [1.e-8:1.0e-3]
set ytics 10 offset 0.75,0
set mytics 10


set key width -1 right bottom box opaque spacing 1 samplen 1 Left reverse
...
plot \
file01 u 1:3 w l ls 101 lw 2 title '\small $L_\infty$',\
file01 u 1:2 w l ls 102 lw 2 title '\small $L_2$',\
